...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libspatialindex-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libspatialindex-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libspatialindex
# for installing globally
pixi global install libspatialindex
```
...
It is possible to list all of the versions of `libspatialindex` available on your platform:
...
```
pixi search libspatialindex --channel conda-forge
```
